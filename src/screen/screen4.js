 ...
 const App = ({navigation}) => {
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
        ...
        <Text style={Styles.imgText1}>Business Details</Text>

         
        <View style={Styles.imgText2}>
        <View style={Styles.labelDesign}>
          <Text style={Styles.imgText3}>Business Name</Text>
          </View>
          <TextInput style={Styles.imgText4} placeholder='please enter business name'/>

         
          <View style={Styles.labelDesign}>
          <Text style={Styles.imgText3}>State</Text>
          </View>
          <TextInput style={Styles.imgText4} placeholder='please select state'/>


          <View style={Styles.labelDesign}>
          <Text style={Styles.imgText3}>City</Text>
          </View>
          <TextInput style={Styles.imgText4} placeholder='Please select city'/>


          <View style={Styles.labelDesign}>
          <Text style={Styles.imgText3}>Create Pin</Text>
          </View>
          <TextInput style={Styles.imgText4} placeholder='____   ____   ____   ____ '/>
        ...
        <View style={Styles.ArrowbuttonPosition}>
          <TouchableOpacity style={Styles.buttonDesign}>
            ...
            <View style={Styles.buttonDesign1}>
              <Text style={Styles.buttonText} onPress={() => navigation.navigate("PersonalDetails")}>Back</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={Styles.buttonDesign}>
            <View style={Styles.buttonDesign1}>
              <Text style={Styles.buttonText} onPress={() => navigation.navigate("ChooseUserType")}>Next</Text>
            </View>
            <Image
              source={forwardImg}
